...
import gif1 from "../../Assets/opinion1.PNG";
import gif2 from "../../Assets/opinion2.PNG";
import gif3 from "../../Assets/opinion3.PNG";
            ...
            <main className='container'>
                <div className='info-img-container'>
                    <aside className='img-container-about'>
                        {selectedInfo && <img src={selectedInfo.src} alt="Selected topic" className='img-selected' />}
                    </aside>
